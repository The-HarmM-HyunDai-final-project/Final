					...
					<div data-v-47cbe816="" class="content">
						<div data-v-45542174="" data-v-47cbe816=""
							...
							<div data-v-45542174="" class="user_explain">
								<p data-v-45542174="" class="main_txt">✌️✌️${member_email}👍🏻</p>
							...
							<ul data-v-392ec340="" class="tab_list">
								...
								<li data-v-392ec340="" class="tab_item" id="follower"><a
									data-v-392ec340="" class="tab_link" style="cursor: hand;"><span
										...
										id="followerCnt" data-v-392ec340="" class="menu_count">${followerCnt}</span></a></li>
								<li data-v-392ec340="" class="tab_item" id="following"><a
									data-v-392ec340="" class="tab_link" style="cursor: hand;"><span
										id="followingCnt" data-v-392ec340="" class="tab_menu">팔로잉</span><span
						...
						<form action="/social/user/postEnroll" method="post"
							...
							<input type="hidden" name="member_email" id="mid" value="${MID}">
											...
											<div style="width: 500px; padding-right: 30px">
												...
												<div id="upload_product">
													<div>
														...
														<input type="hidden" name="pid0" value="0"> <input
															type="hidden" name="pid1" value="0"> <input
															type="hidden" name="pid2" value="0">
													</div>
													<div id="upload_img_box" style="margin-top: 15px">
														<div class="upload_plus_box" id="search_product"
															data-pid="no">
															<img src="https://raw.githubusercontent.com/parkjs5143/KREAM/master/src/main/resources/static/lib/img/2561435_plus_file_icon.png" alt=""
                              ...
                              <use data-v-55a73341="" data-v-1a009402=""
								...
								<div data-v-1a009402="" class="layer_content">
									...
									<div data-v-754300ce="" data-v-55a73341=""
										class="user_list_content" style="" data-v-1a009402="">
										<ul data-v-754300ce="" class="user_list"
											id="follower_container">
											<!-- 팔로우 리스트 뜨는 곳 -->
										</ul>
										<!---->
									</div>
	...
	<div id="popupDiv" style="display: none">
		<div class="layer_container2">
			...
			<div class="layer_header">
				...
				<img src="https://raw.githubusercontent.com/parkjs5143/KREAM/master/src/main/resources/static/lib/img/2561435_plus_file_icon.png" alt="닫기"
   ...
   $(window)
         .ready(
               function() {
                  ...
                  //팔로잉 리스트 & 팔로우 리스트 띄우기
                  console.log("리스트 띄우기");
                  let email = document.getElementById("member_email").innerText;
                                ...
                                tmp +=   `
                                   <li data-v-754300ce="" class="user_item">
                                      ...
                                      if (following.follow == '팔로잉') {
                                         tmp += `
                                            <button data-v-575aff82="" data-v-625671d1="" data-v-754300ce="" type="button" class="btn outlinegrey small btn_follow small"> 팔로잉 </button> `;
                                         
                                      } else {
                                         tmp += `
                                            <button data-v-575aff82="" data-v-625671d1="" data-v-754300ce="" type="button" class="btn solid small btn_follow small">팔로우</button>   `;         
                                      }
