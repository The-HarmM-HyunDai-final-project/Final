...
<div class="container login" data-v-464f7370="" data-v-3007c576="">
			...
			<form id="loginForm" name="loginForm" method="post">
				<div class="has_button input_box" data-v-1c44afeb=""
					...
					<div class="input_item" data-v-1c44afeb="">
						<input type="email" name="username" placeholder="예) kream@kream.co.kr"
	...
	<div class="banner_bottom lg" data-v-e5d8b6f4="" data-v-464f7370="">
		<a href="#" class="banner_box" data-v-e5d8b6f4=""><img
			src="/controller/resources/img/home_banner_bottom1.79549cb.png"
			loading="lazy" width="350" height="200" alt="SERVICE GUIDE"
			class="bg" data-v-e5d8b6f4="">
			<div class="banner_info" data-v-e5d8b6f4="">
				<strong class="info_subtitle" data-v-e5d8b6f4="">service
					guide</strong>
				<p class="info_title" data-v-e5d8b6f4="">
					KREAM은 처음이지? <br>서비스 소개를 확인해보세요.
				</p>
				<span class="info_txt" data-v-e5d8b6f4="">서비스 안내</span>
			</div></a><a href="#" class="banner_box" data-v-e5d8b6f4=""><img
			src="/controller/resources/img/home_banner_bottom2.0077547.png"
			loading="lazy" width="350" height="200" alt="DOWNLOAD THE APP"
			class="bg" data-v-e5d8b6f4="">
			<div class="banner_info" data-v-e5d8b6f4="">
				<strong class="info_subtitle" data-v-e5d8b6f4="">download
					the app</strong>
				<p class="info_title" data-v-e5d8b6f4="">
