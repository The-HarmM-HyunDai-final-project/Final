...
export interface Emitter<EventMap> {
    ...
    on<Key extends keyof EventMap>(event: Key, callback: (value: EventMap[Key]) => void): void;
    on<Key extends string>(event: Key, callback: Callback): void;
    off<Key extends keyof EventMap>(event: Key, callback: (value: EventMap[Key]) => void): void;
