...
import { type IEventEmitter } from './emitter.types';
export declare type Report = RTCTransportStats & {
    [key: string]: unknown;
};
/**
...
/**
 * A utility class wrapping the RTCPeerConnection instiation and lifecycle management.
 */
export declare class PeerClient {
     ...
     */
    constructor(config: Config, analyticsTracker: AnalyticsTracker, emitter: IEventEmitter, logger: Logger);
    /**
